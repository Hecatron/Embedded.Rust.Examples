...
pub const CONFIG_ESPTOOLPY_WITH_STUB: u32 = 1;
...
pub const CONFIG_BLINK_GPIO: u32 = 5;
...
extern "C" {
    pub static mut __sf_fake_stdout: __sFILE_fake;
}
extern "C" {
    pub static mut __sf_fake_stderr: __sFILE_fake;
}
extern "C" {
...
extern "C" {
    pub fn xthal_calc_cacheadrdis(e: *mut xthal_MPU_entry, n: u32) -> u32;
}
extern "C" {
...
extern "C" {
    ...
    pub fn esp_timer_create(
        create_args: *mut esp_timer_create_args_t,
...
extern "C" {
    pub static mut soc_memory_type_count: size_t;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
extern "C" {
    pub static mut soc_memory_region_count: size_t;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " @return ESP_OK on success"]
    pub fn esp_derive_local_mac(local_mac: *mut u8, universal_mac: *mut u8) -> esp_err_t;
}
extern "C" {
...
extern "C" {
    pub fn xTaskCreateRestricted(
        pxTaskDefinition: *mut TaskParameters_t,
...
extern "C" {
    ...
    #[doc = " @endcode"]
    #[doc = " \\ingroup Tasks"]
    pub fn vTaskAllocateMPURegions(xTask: TaskHandle_t, pxRegions: *mut MemoryRegion_t);
}
extern "C" {
...
extern "C" {
    pub fn xTaskRemoveFromEventList(pxEventList: *mut List_t) -> BaseType_t;
}
extern "C" {
...
extern "C" {
    ...
    #[doc = "     - ESP_OK   Success"]
    #[doc = "     - ESP_FAIL Parameter error"]
    pub fn uart_param_config(uart_num: uart_port_t, uart_config: *mut uart_config_t) -> esp_err_t;
}
extern "C" {
    ...
    #[doc = "     - ESP_OK   Success"]
    #[doc = "     - ESP_FAIL Parameter error"]
    pub fn uart_intr_config(uart_num: uart_port_t, intr_conf: *mut uart_intr_config_t)
        -> esp_err_t;
}
extern "C" {
