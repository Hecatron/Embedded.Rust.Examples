...
sidebar: {label: "Flashing"}
---

There are a few different methods to flash an STM32 board
...
### Cargo Embed Configuration

cargo embed can be configured with a `Embed.toml` file

  * [Cargo Embed Configuration](https://probe.rs/docs/tools/cargo-embed/#configuration)
  * [Example probe-rs configuration](https://github.com/probe-rs/probe-rs/blob/master/probe-rs/src/bin/probe-rs/cmd/cargo_embed/config/default.toml)
